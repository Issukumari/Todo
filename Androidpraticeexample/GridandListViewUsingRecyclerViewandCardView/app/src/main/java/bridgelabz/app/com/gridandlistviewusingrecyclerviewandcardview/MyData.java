package bridgelabz.app.com.gridandlistviewusingrecyclerviewandcardview;
...
public class MyData {
    ...
    static Integer[] drawableArray = {R.drawable.s, R.drawable.smi, R.drawable.todoist,
            R.drawable.tt, R.drawable.u, R.drawable.w, R.drawable.s,
            R.drawable.smi, R.drawable.todoist, R.drawable.tt,R.drawable.u};

...
public class MyData {
    ...
    public static Integer[] drawableArray = {R.drawable.b, R.drawable.d, R.drawable.i,
            R.drawable.s, R.drawable.smi, R.drawable.goog, R.drawable.bridgelabz,
            R.drawable.b, R.drawable.tt, R.drawable.u,R.drawable.w};

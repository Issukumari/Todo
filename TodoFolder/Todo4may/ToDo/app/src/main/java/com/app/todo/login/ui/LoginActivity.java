...
public class LoginActivity extends BaseActivity implements LoginActivityInterface, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void getfacebookdata(String uid, JSONObject jsonObject) throws JSONException {
        ...
        editor.putString(getString(R.string.firstname), jsonObject.getString("first_name"));
        editor.putString(getString(R.string.lastname), jsonObject.getString("last_name"));
        editor.putString(getString(R.string.name), jsonObject.getString("name"));

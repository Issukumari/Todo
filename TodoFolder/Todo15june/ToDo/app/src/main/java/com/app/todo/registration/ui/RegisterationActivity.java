...
public class RegisterationActivity extends BaseActivity implements RegistrationActivityInterface {
    ...
    public boolean validate() {
        ...
        mMatcher = mPattern.matcher(editTextPasswordd.getText().toString());
         nameTxt = editTextName.getText().toString();
    ...
    @Override
    public void registrationSuccess(UserDatamodel datamodel, String uid) {
        sharedpreferences = getApplicationContext().getSharedPreferences(Constants.keys, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedpreferences.edit();
        editor.putString(getString(R.string.name), datamodel.getNameRegistration().toString().trim());
        editor.putString(getString(R.string.email), editTextEmail.getText().toString().trim());
        editor.putString(getString(R.string.password), editTextPasswordd.getText().toString().trim());

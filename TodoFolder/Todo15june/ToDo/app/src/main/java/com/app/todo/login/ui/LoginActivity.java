...
public class LoginActivity extends BaseActivity implements LoginActivityInterface, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void initView() {
        ...
        signInButton = (AppCompatButton) findViewById(R.id.google_sign_in_button);
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        if (result.isSuccess()) {
            ...
            editor.putString(getString(R.string.Pic), profile_pic.toString());
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                editor.putString(getString(R.string.uid), task.getResult().getUser().getUid());
                                editor.commit();
                                startActivity(new Intent(LoginActivity.this, TodoHomeActivity.class));
                                finish();
    ...
    public void loginSuccess(UserDatamodel model, String uid) {
        ...
        editor.putString(getString(R.string.name),model.getNameRegistration().toString().trim());
    ...
    public void getfacebookdata(String uid, JSONObject jsonObject) throws JSONException {
        /*sharedpreferences = getApplicationContext().getSharedPreferences(Constants.keys, Context.MODE_PRIVATE);
        String emailid = jsonObject.getString(Constants.email);
        editor.putBoolean(Constants.fbloginkeys, true);
        editor.putString(getString(R.string.email), emailid);
        editor.putString(getString(R.string.firstname), jsonObject.getString(Constants.first_name));
        editor.putString(getString(R.string.lastname), jsonObject.getString(Constants.last_name));
        editor.putString(getString(R.string.name), jsonObject.getString(Constants.name));
        editor.putString(getString(R.string.id), jsonObject.getString("id"));
        editor.putString("uid", uid);
        editor.commit();
        startActivity(new Intent(this, TodoHomeActivity.class));
        finish();
        Toast.makeText(LoginActivity.this, getString(R.string.welcome) + jsonObject.getString(getString(R.string.first_name)), Toast.LENGTH_SHORT).show();
*/
        sharedpreferences = getApplicationContext().getSharedPreferences(Constants.keys, Context.MODE_PRIVATE);

...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
    ...
    public RecyclerAdapter(Activity activity, List<TodoHomeDataModel> datamodels, ShareFragment shareFragment) {
        this.context = activity;
        this.datamodels = datamodels;
    ...
    public void onBindViewHolder(final RecyclerAdapter.ViewHolder holder, final int position) {
        ...
        holder.time.setText(data.getRemindertime());
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                ////    holder.linearlayout.setBackgroundColor(R.color.back_);
    ...
    public void onTodoNoteMove(int from, int to) {
        datamodels.add(to, datamodels.remove(from));
        notifyItemMoved(from, to);
    }

    public List<TodoHomeDataModel> getallnotesdata() {
        return datamodels;
    }
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.card_view:
                    ...
                    bundle.putString("remindertime",dataModel.getRemindertime());
...
*/
                    ...
                    if (notesFragment != null || reminderFragment != null) {
                        ...
                        shareFragment.sharenotes(getAdapterPosition());

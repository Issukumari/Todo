...
public class Constants {
    public static final String STR_LINEAR_GRID ="STR_LINEAR_GRID" ;
...
*/
    public static String FirebaseURL ="https://todo-5865c.firebaseio.com/";
    ...
    public static String name="name";
    public static String currentDateKey="currentDateKey";
    public static String key_firebase_user="key_firebase_user";
    public static String USER_PROFILE_LOCAL="localprofile";
    public static String USER_PROFILE_SERVER="USER_PROFILE_SERVER";
    public static String login="user login";
    public static String color="color";
    public static String remindertime="remindertime";
    public static String uid="uid";
    public static String nullvalues="nullvalues";
    public static String KEY_NOTE="keynote";

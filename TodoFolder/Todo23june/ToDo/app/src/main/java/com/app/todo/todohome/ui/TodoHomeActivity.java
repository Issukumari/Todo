...
import com.app.todo.sharefragment.ui.ShareFragment;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_Reminders:
                ...
                FragmentTransaction reminder = getFragmentManager().beginTransaction();
                reminder.setCustomAnimations(R.anim.anim_left_to_right, R.anim.anim_right_to_left);
                reminder.replace(R.id.frame, reminderFragment).addToBackStack(null);
                reminder.commit();
                drawer.closeDrawers();
                break;
            case R.id.nav_Archive:
                ...
                getFragmentManager()
                        .beginTransaction()
                        .setCustomAnimations(R.anim.anim_left_to_right, R.anim.anim_right_to_left)
            ...
            case R.id.nav_Deleted:
                ...
                trash.setCustomAnimations(R.anim.anim_left_to_right, R.anim.anim_right_to_left);
            ...
            case R.id.nav_Share:
                ...
                ft.replace(R.id.frame, sharefragment, "sharefragment").addToBackStack(null);
                ft.commit();
                drawer.closeDrawers();
                break;
        }

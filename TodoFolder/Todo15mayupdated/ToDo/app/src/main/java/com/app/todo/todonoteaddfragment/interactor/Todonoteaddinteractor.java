            ...
            mfirebasedatabase.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.child("note_details").hasChild(uid)) {
                        ...
                        todoHomeDataModels.addAll(dataSnapshot.child("note_details").child(uid).child(currentDate).getValue(arrayListGenericTypeIndicator));
                        index = todoHomeDataModels.size();
                    }

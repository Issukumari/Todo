...
public class TodoHomeActivity extends BaseActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    private boolean setSetArchieve;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_Archive:
                getSupportFragmentManager().beginTransaction()
                        .replace(R.id.frame, new ArchiveFragment()).
                        addToBackStack(null)
                        .commit();
                setTitle("Archive");
                //ArrayList<TodoHomeDataModel> allnotes = new ArrayList<>();
              /*  if (setSetArchieve == true) {
                    todoHomeDataModel.setReminder = false;

                }*/
                //TodoHomeDataModel.setArchieve=true;
               /* todoHomeDataModel.setSetArchieve(true);
                mfirebasedatabaseref.child("note_details").child(uid).child(currentDate).child(String.valueOf(todoHomeDataModel.getId())).setValue(todoHomeDataModel);*/
                fab.setVisibility(View.INVISIBLE);

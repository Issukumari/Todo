...
public class TodoHomeActivity extends BaseActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    private void fbuser() {
        ...
        String imageUrl = Constants.Adjust_code_style_settings + sharedPreferences.getString(Constants.id, "") + "/picture?type=large";
    ...
    private void googleuser() {
        ...
        google_imageUrl = sharedPreferences.getString(Constants.Pic, Constants.values);

...
public class TodoHomeActivity extends BaseActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener, TodoHomeActivityInterface, ColorPickerDialogListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.nav_Notes:
                ...
                getFragmentManager().beginTransaction().replace(R.id.frame, notefragment).addToBackStack(null)
                        .commit();
            ...
            case R.id.nav_Reminders:
                ...
                getFragmentManager().beginTransaction().replace(R.id.frame, reminderFragment).
                        addToBackStack(null)
                        .commit();
            ...
            case R.id.nav_Archive:
                ...
                getFragmentManager().beginTransaction().replace(R.id.frame, archieveFragment).
                        addToBackStack(null)
                        .commit();
            ...
            case R.id.nav_Deleted:
                ...
                getFragmentManager().beginTransaction().replace(R.id.frame, trashFragment).
                        addToBackStack(null)
                        .commit();

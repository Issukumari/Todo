...
int index;
   ...
   /* public NotesFragment(TodoHomeActivity todoHomeActivity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //titletextview=(AppCompatTextView)view.findViewById(R.id.toolbar);
...
*/
    ...
    public void getIndexUpdateNotes(TodoHomeDataModel doItemModel, List<TodoHomeDataModel> toDoItemModel) {
       ...
       // database.removeItem(doItemModel);
    ...
    private void removeData(List<TodoHomeDataModel> toDoItemModels, int index) {
        ...
        if (toDoItemModels.size() == 1) {
            ...
            //mRef.child(uId).child(startdate).child(String.valueOf(pos)).setValue(toDoItemModels.get(0));
            ...
            for (TodoHomeDataModel todoNote : toDoItemModels) {
                try {
                    ...
                    todoNote.setId(pos);
                    mRef.child(uId).child(todohomedatamodel.getStartdate()).child(String.valueOf(pos)).setValue(todohomedatamodel);
                    pos = pos + 1;
                } catch (Exception f) {
                    Log.i(TAG, "setData: ");
                }
            }
            mfirebasedatabaseref.child(uId).child(todohomedatamodel.getStartdate()).child(String.valueOf(pos)).setValue(null);
        }
